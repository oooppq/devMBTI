...
function addAnswer(qIdx, aIdx, answerText){
...
function goNext(qIdx){
    ...
    document.querySelector('.countStatus').innerHTML = (qIdx + 1) +'/'+ endPoint
    document.querySelector('.statusBar').style.width = (qIdx + 1)/endPoint * 100 + '%'
    document.querySelector('.qBox').innerHTML = qnaList[qIdx].q
    for(let aIdx in qnaList[qIdx].a){
        addAnswer(qIdx, aIdx, qnaList[qIdx].a[aIdx].answer);
    }    
